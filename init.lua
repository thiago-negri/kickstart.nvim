...
vim.g.maplocalleader = ' ' -- <LocalLeader> = space
vim.g.have_nerd_font = true -- Set to true if you have a Nerd Font installed and selected in the terminal
vim.opt.number = true -- Make line numbers default
vim.opt.relativenumber = true -- Relative line numbers by default
...
vim.opt.showmode = false -- We already show mode in the statusline
...
vim.o.smartcase = true -- OR one or more capital letters in the search term
vim.o.signcolumn = 'yes' -- Keep signcolumn on by default, otherwise the text shifts a column when it shows
vim.o.updatetime = 250 -- Decrease update time
vim.o.timeoutlen = 300 -- Decrease mapped sequence wait time
vim.o.splitright = true -- New vertical splits shows right
vim.o.splitbelow = true -- New splits shows below
vim.o.list = true -- Show whitespace characters
vim.opt.listchars = {
  tab = '» ', -- How to display tab characters
  trail = '·', -- How to display trailing spaces
  nbsp = '␣', -- How to display NBSP
}

-- Break long lines
vim.keymap.set('n', '<leader>tw', '<cmd>set wrap!<CR>', { desc = '[T]oggle Line [W]rapping' })
vim.opt.showbreak = '↪ '
...
vim.o.confirm = true -- Show confirm dialog instead of failing operation (e.g. :q)

-- vim.opt.colorcolumn = '120' -- Show ruler at column 120
...
require('lazy').setup({
  ...
  -- TNEGRI(?)  'tpope/vim-sleuth', -- Detect tabstop and shiftwidth automatically
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sw', function()
        builtin.grep_string { additional_args = { '--trim' } }
      end, { desc = '[S]earch current [W]ord' })
      vim.keymap.set('n', '<leader>sg', function()
        builtin.live_grep { additional_args = { '--trim' } }
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- TNEGRI: No highlight of references
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      -- TNEGRI: No auto formatting, thanks
